...
Many machine learning researchers already seem to regard successful predictions (under the rubric of "cross-validation" and related approaches) as a direct rationale for using a given model, so that embracing the argument here would have little or no impact on their practice. Others (such as most economists, in my experience) regard the use of cross-validation for model selection as an ad hoc approach that could only be justified in terms of more traditional statistics concepts, if at all. Philosophers seem to generally share this latter attitude. As a recent review article on "Philosophy of Statistics" puts it, in a section discussing some approaches to model selection: "methods that use cross-validation...have, unduly, not received as much attention in the philosophical literature."[^1]
...
Also of clear relevance is the literature summarized by [barnes2022] debating why, or whether, novel predictions should receive more weight than mere accomodation in assessing scientific theories. I regard the question of predictions versus accomodation as somewhat of a false choice. I advocate approaching past data from the perspective of whether it could have been predicted using other past data, akin to how cross-validation works. 

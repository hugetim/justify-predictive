...
As a slightly less simple example, consider the non-linear prediction task presented in [@forster2000]. Suppose you observe the values of a function $y = f(x)$ at evenly spaced intervals of $x$ between 0 and 3.5, the values shown in @fig-known-data, and you want to predict the values for $x$ between 3.5 and 5.

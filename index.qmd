...
Also of clear relevance is the literature summarized by [barnes2022] debating why, or whether, novel predictions should receive more weight than mere accomodation in assessing scientific theories. I regard the question of predictions versus accomodation as a false choice which dissolves once we re-frame past data from the perspective of whether part of it *could have been predicted* using other past data. 

The argument proceeds as follows. @sec-under shows how thinking in terms of predictive methods alleviates the problem of underdetermination. Given that, @sec-prag lays out a pragmatic justification for the case of deterministic predictions. @sec-prob extends that justification to probabilistic predictions. @sec-class discusses a possible weak point in the preceding sections. @sec-induct addresses the major arguments against Reichenbach's closely related pragmatic justification of induction. @sec-schurz relates the framework of this paper to a prominent recent attempt to justify induction with reference to prediction. The final section concludes by sketching out the philosophical interpretation of probability that emerges from @sec-prob.

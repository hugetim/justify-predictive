---
title: Towards a universal approach to model selection
author:
  - name: Tim Huegerich
...
[^1]: Elsewhere I argue that this simple principle provides a way out of the philosopher David Hume’s “problem of induction,” solving the problem of underdetermination. That is, I claim it provides the proper perspective for thinking about the reliability of science and all inductive inference. But this paper mostly sets aside those broader aims.

::: callout-note
Cite [@hansen2005] and [@busemeyer2000]
:::
...
::: callout-note
Should weight the validation tests based on similarity to the task for which it will be used. That may simply mean equal weights (when LOO is appropriate, for example).
:::

...
Yet, what if there were a predictive method that could have plausibly predicted any held out point but differs from the best-fit line in its predictions for unknown points? It is difficult to imagine a Case 2 predictive method that would match the best-fit line in the example at hand, and that is the case for many other predictive methods. But that is not always the case, and we will revisit such cases in the following section.

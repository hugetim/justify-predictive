...
[^23]: \[\[Should weight the validation tests based on similarity to the task for which it will be used, specifying $w_j$ for $j=1, ..., J$. That may simply mean equal weights (when LOO is appropriate, for example).\]\]

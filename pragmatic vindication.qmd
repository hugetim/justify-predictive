...
No, when in doubt, we can expand the prediction class out to the whole world, weighting according to importance. More narrow prediction classes can ultimately be evaluated by how well their selected predictive methods perform in terms of this universal metric of predictive success.

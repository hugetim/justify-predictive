...
* Define proposition assuming fully-specified predictions, with likelihood as the metric. Relegate partially specified to footnote. Treat example as "homoskedastic, for simplicity," for now.

...
* First Gaussian noise as simplest example, but then also maybe present sin curve fitting example, in which linear is best (even without truly random noise)
* Generalize proposition with "most successful" and explain that the measure is generally context-specific (but generically likelihood)

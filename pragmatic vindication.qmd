...
::: {#def-predictive}
A *predictive method* is a procedure for using some input information $A$ to predict some outcome(s) $B$. It includes all concepts and tacit knowledge required to carry out the steps.
:::

...
than mere accomodation in assessing scientific theories. I regard the
question of predictions versus accomodation as a false choice which
dissolves once we re-frame past data from the perspective of whether
part of it \emph{could have been predicted} using other past data.
...
predictive accuracy of that method.\footnote{The phrase ``predictive
  ...
  distribution in terms of the Kullback-Liebler divergence, the average
